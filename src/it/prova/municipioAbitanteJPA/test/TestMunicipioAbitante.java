...
public class TestMunicipioAbitante {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("In tabella Abitante ci sono " + abitanteService.listAllAbitanti().size() + " elementi." );
	...
	private static void testFindAllByCognome(MunicipioService municipioService,AbitanteService abitanteService) throws Exception {
		...
		String cognomeDaInserire = "Plutorum";
		
		List<Abitante> result = abitanteService.findAllByCognome(cognomeDaInserire);
		
		for(Abitante a : result)
			System.out.println(a);
	}
	
	private static void testFindAllByCodiceMunicipioIniziaCon(MunicipioService municipioService,AbitanteService abitanteService) throws Exception {
		...
		String codiceMunicipio = "I";
		
		List<Abitante> result = abitanteService.findAllByCodiceMunicipioIniziaCon(codiceMunicipio);
